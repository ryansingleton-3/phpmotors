...
switch ($action) {
    ...
    $message = '<p class="notice" style="color: red;">You must select a vehicle and image file for the vehicle.</p>';
    } else {
    ...
    if ($result) {
    $message = '<p class="notice" style="color: red;">The upload succeeded.</p>';
    } else {
    $message = '<p class="notice" style="color: red;">Sorry, the upload failed.</p>';
    }
    }
    ...
    if ($remove) {
    $message = "<p class='notice' style='color: green;'>$filename was successfully deleted.</p>";
    } else {
    $message = "<p class='notice' style='color: red;''>$filename was NOT deleted.</p>";
    }
    ...
    $imageDisplay = '<p class="notice" style="color: red;">Sorry, no images could be found.</p>';
    }
